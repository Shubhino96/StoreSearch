...
public class Furnitures extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Storelist>> {
    final String FURN_URL="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=18.975,%2072.825833&radius=700&type=furniture_store&key=AIzaSyDihnpkEId44HFnz27y0BzTSz0wQinb-Yo";
    ...
    public Loader<List<Storelist>> onCreateLoader(int i, Bundle bundle) {
        return new Storeloader(this, FURN_URL);
    }
