...
public class Electronics extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Storelist>>{
    final String ELECTR_URL="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=18.975,%2072.825833&radius=1000&type=electronics_store&key=AIzaSyDihnpkEId44HFnz27y0BzTSz0wQinb-Yo";
    ...
    public Loader<List<Storelist>> onCreateLoader(int i, Bundle bundle) {
        return new Storeloader(this, ELECTR_URL);
    }
